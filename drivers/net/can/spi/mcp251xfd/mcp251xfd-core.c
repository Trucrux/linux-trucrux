...
{
	u32 osc, osc_reference, osc_mask, reg_read;
	int err, err2;
	...
	err2 = regmap_read(priv->map_reg, MCP251XFD_REG_OSC, &reg_read);

//	err = regmap_write(priv->map_reg, MCP251XFD_REG_OSC, osc);
	err = regmap_write(priv->map_reg, MCP251XFD_REG_OSC, 0x00000460);
	if (err)
		return err;
